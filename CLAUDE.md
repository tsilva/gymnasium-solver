...
# Note: Modal training automatically handles preemption
# If training is interrupted (preempted), it will automatically resume from the last checkpoint
```
