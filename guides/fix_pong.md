...
- Value head underfits near plateau: opt/value/explained_variance drops to ~0.68 around the stall; opt/loss/value rising slightly.
...
- Spawn a new run with the above changes; monitor:
  ...
  - train/opt/value/explained_variance trending back >0.8
