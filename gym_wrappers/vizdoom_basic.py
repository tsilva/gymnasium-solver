...
class VizDoomBasicEnv(gym.Env):
    """Minimal Gymnasium wrapper around ViZDoom Basic scenario.

    This environment expects ViZDoom to be installed (pip install vizdoom).

    Parameters (via env_kwargs):
        config_path: Optional[str] - Path to basic.cfg. If not provided,
    ...
    def __init__(
        ...
        **_: Dict[str, Any],
        ...
        try:
            ...
            raise ImportError(
                "vizdoom package is required for VizDoomBasicEnv. "
        ...
        if cfg_path is None:
            raise FileNotFoundError(
                "Could not locate basic.cfg. Set env_kwargs.config_path "
