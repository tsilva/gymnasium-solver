...
class WandbLoggerAutomedia(WandbLogger):
    """
    Lightning WandbLogger subclass that automatically logs files found under
    <run.dir>/<media_root>/<namespace>/<name>/*.{mp4,gif,png,jpg}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            commit: passed to wandb.log; default False to avoid step changes.
        """
    ...
    def _scan_and_log_once(self):
        ...
        root = Path(run.dir) / self.media_root
        if not root.exists():
            return
